...
use KaitoSaikyo\LaravelLivewireTables\Views\Traits\Filters\{HasOptions};

class NumberRangeFilter extends Filter
{
    use HasOptions;

    protected string $view = 'livewire-tables-kaito::components.tools.filters.number-range';
